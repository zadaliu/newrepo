<template>
	<div class="app-container">
		...
		<el-card class="operate-container" shadow="never">
			...
			<span>数据列表</span>
			<el-button size="mini" class="btn-add" @click="handleAdd()">新建秒杀</el-button>
		</el-card>
		<div class="table-container">
			<el-table ref="homeAdvertiseTable" :data="list" style="width: 100%;" @selection-change="handleSelectionChange" v-loading="listLoading" border>
				...
				<el-table-column label="秒杀订单数"  align="center">
					<template slot-scope="scope">{{scope.row.delegationDiscountNumber}}</template>
				</el-table-column>
				<el-table-column label="秒杀人数"  align="center">
				...
				<el-table-column label="操作" width="200" align="center">
					<template slot-scope="scope">
						...
						<el-button size="mini" type="text" @click="handleUpdate(scope.$index, scope.row)">失败
						</el-button>
		...
		<el-dialog title="效果数据" :visible.sync="dialogTableVisible">
			...
			<el-row style="padding-top: 20px;">
				<el-col :span="8">
					<div class="grid-content bg-purple">￥{{assebleEffect.countMoney}}</div>
				</el-col>
				<el-col :span="8">
...
<script>
	import { fetchList, deleteHomeAdvertise, EffectList, updateStatus } from '@/api/seckill';
