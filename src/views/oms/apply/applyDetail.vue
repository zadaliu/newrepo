  ...
  <div class="detail-container">
    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===1">
      	 <el-col class="form-border form-left-bg font-small" :span="6">用户发货公司</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.returnCompany | returnNull}}</el-col>
        <el-row>
        	 <el-col class="form-border form-left-bg font-small" :span="6">用户发货快递单号</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.returnOrder | returnNull}}</el-col>
