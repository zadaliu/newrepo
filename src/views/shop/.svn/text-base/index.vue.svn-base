<template>
	<div class="app-container">
		...
		<el-card class="operate-container" shadow="never">
			...
			<span>数据列表</span>
			<el-button size="mini" class="btn-add" @click="handleAdd() ">创建页面</el-button>
    </el-card>
...
<script>
  import { deleteSelectAll,fetchList,getTitle,updateTitle  } from '@/api/fontMenu';
...
//    	this.dialogVisible = true;
		this.$router.push({path: '/shop/addShopManage'})
      },
      handleUpdate(index,row){
      	this.$router.push({
					path: '/shop/updateShopManage',
					query: {
						id: row.id
					}
				})
