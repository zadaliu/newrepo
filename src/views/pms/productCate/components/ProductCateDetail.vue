	...
	<el-card class="form-container" shadow="never">
		<el-form :model="productCate" :rules="rules" ref="productCateFrom" label-width="150px">
			...
			<el-form-item label="分类别名：" prop="alias">
				<el-input v-model="productCate.alias"></el-input>
			</el-form-item>
			...
			<el-form-item v-for="(filterProductAttr, index) in filterProductAttrList" :label="index | filterLabelFilter" :key="filterProductAttr.key">
