...
<script>
  import {createBrand, getBrand,getGroup, updateGroup} from '@/api/brand'
...
//        ],
    ...
    created() {
    	console.log("data===1111111==="+this.isEdit);
      if (this.isEdit) {
        ...
        this.$refs[formName].validate((valid) => {
          ...
          if (valid) {
            this.$confirm('是否提交数据', '提示', {
              ...
              if (this.isEdit) {
                updateGroup(this.$route.query.id, this.brand).then(response => {
