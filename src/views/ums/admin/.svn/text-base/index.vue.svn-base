  ...
  <div class="app-container">
    ...
    <el-dialog
      ...
      <el-form :model="admin"
        ...
        <el-form-item label="供货商：" prop="productGroupId">
			<el-select v-model="admin.supplierId" @change="handleSupplierChange" placeholder="请选择供货商">
...
import {fetchList as supplierList, getSupplier} from '@/api/supplier';
