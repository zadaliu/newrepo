<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()"">新建标签</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column label="微信粉丝"  align="center">
          <template slot-scope="scope">{{scope.row.wechatFans}}</template>
        </el-table-column>
         ...
         <el-table-column label="客户"  align="center">
          ...
          <template slot-scope="scope">{{scope.row.titleStatus | formatTitleStatus}}</template>
        </el-table-column>
        
          
           <el-table-column label="打标条件"  align="center">
          <template slot-scope="scope">{{scope.row.markingStatus | formatMarkingStatus}}</template>
        </el-table-column>
    ...
    <el-button type="primary" @click="editTitle('form')" >确 定</el-button><!--@click="dialogVisible = false"-->
  </span>
					</el-dialog>
...
<script>
		import { createBrand, deleteSelectAll,fetchList,createTitle,getTitle,updateTitle  } from '@/api/title'
