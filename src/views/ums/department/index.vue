  ...
  <div class="app-container">
   <!-- <el-card class="filter-container" shadow="never">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()">添加部门</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column label="部门ID" width="120" align="center">
          <template slot-scope="scope">{{scope.row.id}}</template>
        </el-table-column>
        <el-table-column label="部门名称" align="center">
          <template slot-scope="scope">{{scope.row.deparName}}</template>
        </el-table-column>
        <el-table-column label="上级部门" width="120" align="center">
          <template slot-scope="scope">{{scope.row.topDeparName}}</template>
        </el-table-column>
...
<script>
  import {departmentList,deleteSelectAll} from '@/api/department';
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd(){
        this.$router.push({path: '/ums/adddepartment'})
      },
      handleUpdate(index,row){
        this.$router.push({path: '/ums/updatedepartment', query: {id: row.id}})
      },
      getList() {
